      ...
      <div className="max-w-[1100px] w-full grid md:grid-cols-2 rounded-2xl overflow-hidden shadow-[0px_4px_40px_rgba(0,0,0,0.06)] bg-white">
        ...
        <div className="relative hidden md:flex flex-col justify-between p-12 text-white overflow-hidden bg-primary">
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-md">
              <h1 className="font-display-lg text-[48px] font-bold leading-tight mb-6">Begin your academic journey.</h1>
              <p className="font-body-lg text-[18px] text-white/80">Join thousands of students and researchers using AI to learn faster and retain more.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-16 flex flex-col justify-center bg-surface-container-lowest">
          <div className="mb-8 text-center md:text-left">
            <h2 className="font-headline-lg text-[32px] font-bold text-on-surface mb-2">Create an Account</h2>
            <p className="font-body-md text-[16px] text-on-surface-variant">Get started with your free academic workspace.</p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleRegister}>
            <div>
              <label className="block font-body-md text-sm font-medium text-on-surface-variant mb-1" htmlFor="name">Full Name</label>
              <input
                className="w-full px-4 py-2.5 bg-white border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-label-md"
                id="name" type="text" placeholder="Julian Dubois"
                value={fullName} onChange={(e) => setFullName(e.target.value)} required
              />
            </div>
            
            <div>
              <label className="block font-body-md text-sm font-medium text-on-surface-variant mb-1" htmlFor="email">Email Address</label>
              <input
                className="w-full px-4 py-2.5 bg-white border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-label-md"
                id="email" type="email" placeholder="student@university.edu"
                value={email} onChange={(e) => setEmail(e.target.value)} required
              />
            </div>
            
            <div>
              <label className="block font-body-md text-sm font-medium text-on-surface-variant mb-1" htmlFor="password">Password</label>
              <input
                className="w-full px-4 py-2.5 bg-white border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none font-label-md"
