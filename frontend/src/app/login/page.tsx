...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#ecf4f3] bg-gradient-to-br from-[#e8f3f1] via-[#f1f6f8] to-[#e6f1ee] flex items-center justify-center p-3 sm:p-6 lg:p-8 relative selection:bg-emerald-500 selection:text-white overflow-hidden">
          ...
          <div className="relative z-10 pl-1">
            ...
            <div className="mt-2.5 space-y-1">
              ...
              <svg className="w-14 h-2 text-emerald-400 ml-2" viewBox="0 0 60 8" fill="none">
                <path d="M2 4C18 1 42 6 58 3" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" />
              </svg>
            </div>
          </div>
        </div>
      ...
      {/* Main Card Modal Container (Matches Reference 1:1) */}
      <div className="max-w-[1240px] w-full bg-white rounded-[26px] sm:rounded-[34px] shadow-[0_24px_70px_-12px_rgba(15,23,42,0.12),0_0_1px_1px_rgba(203,213,225,0.4)] border border-white/90 overflow-hidden relative z-10 my-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 min-h-[620px] lg:min-h-[700px] items-stretch">
          
          {/* Left Column: 3D Hero Artwork (58% width matching reference split) */}
          ...
          {/* Right Column: Interactive Login Form (42% width matching reference split) */}
          <div className="md:col-span-5 bg-white p-6 sm:p-8 lg:p-10 flex flex-col justify-between relative">
            
            {/* Top-Right Handwritten Accent: "Smart Learning. Brighter Futures." */}
            ...
            <div className="w-full pt-1 sm:pt-2">
              <div className="mb-6">
                ...
                <p className="text-sm text-slate-500 mt-1 font-normal">
                  Access your academic command center.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
                <button 
                  ...
                  className="h-12 bg-white hover:bg-slate-50/80 border border-slate-200/90 hover:border-slate-300 rounded-xl flex items-center justify-center gap-2.5 px-3 transition-all duration-200 shadow-2xs hover:shadow-xs active:scale-[0.98] cursor-pointer"
                >
              ...
              <form className="space-y-4" onSubmit={handleLogin}>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full h-12 pl-10 pr-4 bg-[#f4f8fb] hover:bg-[#edf3f8] focus:bg-white border border-slate-200/90 focus:border-emerald-500 rounded-xl text-sm text-slate-900 placeholder:text-slate-400 outline-none focus:ring-4 focus:ring-emerald-500/10 transition-all font-sans"
                      id="email"
                      type="email"
                ...
                <div>
                  <div className="flex justify-between items-center mb-1.5">
                    ...
                    <Link className="text-sm font-semibold text-[#0ca668] hover:text-[#098351] hover:underline" href="/reset-password">
                      Forgot password?
                    </Link>
                  </div>
                  <div className="relative">
                ...
                <button 
                  type="submit" 
                  disabled={loading}
                  className="w-full h-12 mt-2 bg-[#0ca668] hover:bg-[#098e59] active:bg-[#077a4c] text-white font-bold text-base rounded-xl transition-all duration-200 shadow-md shadow-emerald-700/20 active:scale-[0.99] disabled:opacity-70 cursor-pointer flex items-center justify-center gap-2"
                >
              ...
              <p className="mt-4 text-center text-slate-600 text-sm">
                ...
                <Link className="text-[#0ca668] hover:text-[#098351] font-bold hover:underline" href="/register">
                  Sign up
                </Link>
              </p>
            </div>

            {/* Bottom Quote Card (Matches Reference Image 1:1) */}
            <div className="mt-6 bg-[#f0fbf5] border border-emerald-100/80 rounded-2xl p-4 sm:p-4.5 flex items-start gap-3 relative overflow-hidden">
              ...
              {/* Hand-drawn mint sketch lines in bottom-right */}
