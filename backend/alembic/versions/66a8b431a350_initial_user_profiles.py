...
Revision ID: 66a8b431a350
Revises: 
Create Date: 2026-07-23 21:47:52.384489
...
def upgrade() -> None:
    ...
    sa.Column('academic_institution', sa.String(length=255), nullable=True),
